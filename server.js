//I. Sử dụng Github lưu code********************************
//1. Đăng ký tài khoản git hub
//2. Tải phần mềm git hub
//3. Cấu hình Git
/**
 * Chuột phải vào folder bất kỳ -> Git bash here //mở cửa sổ gõ lệnh
 * git config --global user.name "Tên user tài khoản github"
 * git config --global user.email "Tên email github"
 * git config --list //xem lại các cấu hình vừa cài đặt
 */
//4. Khởi tạo kết nối
/**
 * git init //Khởi tạo folder git (chạy lần đầu)
 * git add . //Chạy mỗi lần đẩy dữ liệu lên github
 * git commit -m "nội dung lần commit" //Chạy mỗi lần commit đẩy dữ liệu lên github
